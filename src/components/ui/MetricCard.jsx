const MetricCard = ({
  ...
  return (
    <div className="rounded-lg p-4 bg-card-black border border-card-black group flex flex-col justify-between h-full w-full hover:bg-white/2 hover:border-white/20 transition-all duration-300 ease-out">
      {/* Header: Icon + Label */}
      ...
      <div className="flex items-center gap-3">
        ...
        {subValue && (
          <span
            className={
              subValue === "Normal"
                ? "inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs text-green"
